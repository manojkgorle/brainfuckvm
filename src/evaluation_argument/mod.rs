    ...
    fn compute_terminal(&self, challenges: &[FieldElement]) -> FieldElement {
        ...
        for i in 0..padded_program.len() - 1 {
            ...
            if previous_address != address as isize {
                ...
                println!(
                    "{}:{}:{}:{}:{}",
                    i, address, current_instruction.0, next_instruction.0, running_sum.0
                );
            }
        ...
        println!(
            "{}:{}:{}:{}:{}",
            index, address.0, current_instruction.0, next_instruction.0, running_sum.0
        );
        running_sum
    }
...
mod tests {
    ...
    fn test_evaluation_argument() {
        ...
        // Create terminals
        let terminals = vec![FieldElement::new(10, field), FieldElement::new(12, field)];
    ...
    fn test_program_evaluation_argument() {
        ...
        let prog_eval_arg =
            ProgramEvaluationArgument::new(field, challenge_indices, terminal_index, program);
